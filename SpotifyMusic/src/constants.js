 ...
 * @property {number} id - The unique identifier for the track.
 * @property {string} title - The title of the track.
 * @property {string} artist - The artist of the track.
 * @property {string} album - The album of the track.
 * @property {string} artwork - The URL of the track's artwork.
 * @property {string|number} url - The URL or resource ID of the audio file.
 */
