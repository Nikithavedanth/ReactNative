...
const PasswordSchema = yup.object().shape({
  passwordLength:yup.number().min(4, 'Should be min of 4 characters').max(16, 'Should be a max of 16 characters '). required('Length is required')
})
      ...
      <SafeAreaView style={styles.appContainer}>
       ...
       {({
         ...
         <View style={styles.inputWrapper}>
          ...
          <TextInput style={styles.inputStyle} value={values.passwordLength} onChangeText={handleChange('passwordLength') } placeholder='enter the value' keyboardType='numeric'/> 
         </View>
         <View style={styles.inputWrapper}>
