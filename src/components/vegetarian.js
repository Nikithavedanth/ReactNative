...
import { vegetarian, colors } from '../constants';
...
const Vegetarian= () => {
  ...
  return (
    ...
    <View style={{flex:1,marginTop:20}}>
      ...
      <Text style={{fontSize:20, fontWeight:'bold',padding:20, backgroundColor:'lightblue',marginHorizontal:10, borderRadius:10}}>Vegetarian Recipes</Text>
   <View>
      <FlatList data={vegetarian} renderItem={({item})=>(
