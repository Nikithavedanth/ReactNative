...
import { seaFood, colors } from '../constants';
...
const SeaFood= () => {
  ...
  return (
    ...
    <View style={{flex:1,marginTop:20}}>
      ...
      <Text style={{fontSize:20, fontWeight:'bold',padding:20, backgroundColor:'lightblue',marginHorizontal:10, borderRadius:10}}> Seafood Recipes</Text>
   <View>
      <FlatList data={seaFood} renderItem={({item})=>(
