...
import { italian, colors } from '../constants';
...
const Italian= () => {
  ...
  return (
    ...
    <View style={{flex:1,marginTop:20}}>
      ...
      <Text style={{fontSize:20, fontWeight:'bold',padding:20, backgroundColor:'lightblue',marginHorizontal:10, borderRadius:10}}>Italian Recipes</Text>
   <View>
      <FlatList data={italian} renderItem={({item})=>(
