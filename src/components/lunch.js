...
import { lunch, colors } from '../constants';
...
const Lunch= () => {
  ...
  return (
    ...
    <View style={{flex:1,marginTop:20}}>
      ...
      <Text style={{fontSize:20, fontWeight:'bold',padding:20, backgroundColor:'lightblue',marginHorizontal:10, borderRadius:10}}>Lunch Recipes</Text>
   <View>
      <FlatList data={lunch} renderItem={({item})=>(
