...
import {  colors, asian } from '../constants';
...
const Asian= () => {
  ...
  return (
    ...
    <View style={{flex:1,marginTop:20}}>
      ...
      <Text style={{fontSize:20, fontWeight:'bold',padding:20, backgroundColor:'lightblue',marginHorizontal:10, borderRadius:10}}>Asian Recipes</Text>
   <View>
      <FlatList data={asian} renderItem={({item})=>(
